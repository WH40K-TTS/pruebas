      ...
      <div className="mx-auto max-w-7xl px-6 py-10">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <div className="flex items-center gap-3">
            <Hexagon size={18} className="text-amber-500" strokeWidth={1.5} />
            <div>
          ...
          <a
            ...
            className="flex items-center gap-2 px-4 py-2 rounded border border-[#5865F2]/40 bg-[#5865F2]/10 text-[#8b98ff] text-xs font-display font-medium uppercase tracking-wider hover:bg-[#5865F2]/20 hover:border-[#5865F2]/70 transition-all"
          >
